...
//         <div className="flex flex-col md:flex-row m-auto md:m-8 md:mr-0 items-center ssm:mt-8">
//           <motion.div
...
//           >
//             <div className="ml-40 w-[88%] 2xl:mt-[-15%]">
//               <div className="mt-60">
//                 <div>
//                   <h1 className="whitespace-nowrap tracking-[.3rem] ssm:px-1 ssm:text-5xl sm:text-[4.8rem] 2xl:text-[4.7rem] md:mb-0 ssm:text-center md:text-left">
//                     DAVYD SADOVSKYY
//                   </h1>
//                   <h3 className="heading-with-line ml-2 font-semibold w-[92%] py-[10px] text-[21px]">
//                     {" "}
//                     Data scientist
//                   </h3>
//                 </div>
...
//                 <p className="ml-2 w-[92%] ssm:text-center md:text-left md:text-justify mt-7 ssm:mb-5 text-[19px]">

//                   Welcome to my portfolio site! I am a senior at Miami University looking to continue my statistics education
//                   next year with an M.S. I have a specific interest in analyzing unstructured data using LLMs. Working on this site
//                   and some other projects this past half year has introduced to the landscape and process of software creation.
//                   My goal is to continue learning this skill by creating applications that have real world value. If you would like to
//                   get in touch, feel free to send an email or connect on my other social media accounts.

//                 </p>
//               </div>
//               <div className="w-[92%] flex justify-between pt-[10px] text-[19px]">
//                 <div className="ml-2">
...
//           </motion.div>
//           <motion.div
//             className="mt-24 basis-7/12 flex justify-center mr-40"
//             initial={{ opacity: 0, x: 140 }}
//             animate={{ opacity: 1, x: 0, transition: { duration: 1.5 } }}
//             exit={{ opacity: 0, x: -100 }}
//           >
//             <img src={midjourney} className="max-w-[90%] ssm:mr-0 md:mr-[-100px]" alt="Midjourney Generated Illustration" />
//           </motion.div>
//         </div>


//         {/* <HighlightedProjects projects={PROJECTS} /> */}
//         <div className="w-[70%] mt-40 flex flex-col items-center bg-[#EFF6FF] bg-slate-50 min-h-[400px] pt-20 mx-auto mb-24">
//           <h4 className="text-green-600 font-semibold mb-6">TECHNOLOGIES</h4>
//           <h1 className="pt-[20px] pb-[20px]">What I used to build this site</h1>
      ...
      <div className="container">
        <div className="flex flex-col md:flex-row m-auto md:m-8 md:mr-0 items-center ssm:mt-8">
          <motion.div
            ...
            exit={{ opacity: 0, transition: { duration: 1.5 } }}
          >
            <div className="xl:ml-40 2xl:mt-[-15%]">
              <div className="mt-60">
                <div>
                  <h1 className="whitespace-nowrap tracking-[.3rem] ssm:px-1 ssm:text-5xl sm:text-[4.8rem] 2xl:text-[4.7rem] md:mb-0 ssm:text-center md:text-left">
                    DAVYD SADOVSKYY
          ...
          <motion.div
            className="mt-24 basis-7/12 flex justify-center mr-40 xs:mx-20"
            initial={{ opacity: 0, x: 140 }}
            animate={{ opacity: 1, x: 0, transition: { duration: 1.5 } }}
            exit={{ opacity: 0, x: -100 }}
          >
        ...
        {/* <HighlightedProjects projects={PROJECTS} /> */}
        <div className="xl:w-[70%] mt-40 flex flex-col items-center bg-[#EFF6FF] bg-slate-50 min-h-[400px] pt-20 mx-auto mb-24">
          <h4 className="text-green-600 font-semibold mb-6">TECHNOLOGIES</h4>
          <h1 className="pt-[20px] pb-[20px]">What I used to build this site</h1>
          <div className="grid ssm:grid-cols-1 md:grid-cols-2 gap-5 w-4/5 justify-around mt-20 text-left mb-32">
            <TechUsed
