              ...
              <ul className="list-square [padding-left:_clamp(5px,6vw,45px)] pt-[10px]">
                {dataArray.map((course, index) => (
                  <li key={index} className="my-0 position relative">
                    ...
                    {showDescription && activeIndex !== -1 && activeIndex === index && (
                      <div
                        ref={svgRef}
                        id="description1"
...
const NewResume = () => {
  return (
    <div className="container max-w-6xl mt-[7rem] mb-20 px-2 sm:px-10">
      <h1 className="ssm:text-center md:text-left text-6xl">Education</h1>
      <hr className="mt-4"></hr>

      {/* CSU header */}
      <div className="flex justify-between mt-4 flex-wrap gap-y-4 mb-9">
        <h2 className="text-left [font-size:_clamp(18px,5vw,24px)]">Cleveland State University</h2>
        <h2 className="text-left [font-size:_clamp(10px,4vw,24px)] ssm:font-bold md:font-normal">August 2017 - May 2019</h2>
      </div>

      <div className="[padding-left:_clamp(15px,5vw,75px)]">
        <Collapsable
          titles={
      ...
      <div className="flex ssm:flex-col md:flex-row justify-between mt-4 flex-wrap gap-y-4 mb-9">
        <h2 className="text-left [font-size:_clamp(18px,5vw,24px)]">Miami University</h2>
        <h2 className="text-left [font-size:_clamp(10px,4vw,24px)] ssm:font-bold md:font-normal">August 2020 - May 2024</h2>
      </div>
      ...
      <div>
        ...
        <hr className="mt-4"></hr>
        <div className="flex flex-row ssm:flex-wrap sm:flex-nowrap mt-6 shadow sm:w-full md:max-w-[450px] p-5 items-center">
