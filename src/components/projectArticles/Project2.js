...
const Project2 = () => {
    ...
    const projectWithId = PROJECTS.find((project) => project.id === 2);
    ...
    return (
        <div className="container w-[70rem] mt-20 text-left">
            ...
            <h3 className="text-neutral-500 text-[1.9rem] font-normal mt-8 leading-relaxed">
                How I Built my First Website Ever With no Prior Experience Using a Udemy Course, ChatGPT, and Elements From Other Well Designed Websites
            </h3>
            <hr className="w-[64.5rem] mt-8"></hr>
            <div className="w-[64.5rem] flex items-start justify-between">
                <IconsWithText
                    leftText={date}
                    className="mt-4 "
                />
                <div className="mt-2 flex flex-wrap">
                    <a className="pr-[0px]" target="_blank" rel="noreferrer" href="https://github.com/sadovsd/react-portfolio-website">
