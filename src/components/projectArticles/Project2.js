...
const Project2 = () => {
  const projectWithId3 = PROJECTS.find((project) => project.id === 2);
  ...
  return (
    <div className="container mt-20 w-[70rem] text-left">
      ...
      Building Aging Clocks Using Transcriptomic and EEG Data
      </h3>
      <h3
      ...
      >
        ...
        CU Anschutz Rotation #1 with Arjun Krishnan and Brice McConnell
      </h3>
      ...
      <div className="flex items-start justify-between">
        ...
        <a className="xs:pr-[10px] pr-[20px] hover:opacity-70" target="_blank" rel="noreferrer" href="https://github.com/sadovsd/transcriptomics_aging_clock_CORN">
          ...
          <a className="xs:pr-[10px] pr-[20px] hover:opacity-70" target="_blank" rel="noreferrer" href="https://github.com/sadovsd/transcriptomics_aging_clock_CORN/blob/main/rotation1_paper_davyd.pdf">
          ...
          <a className="xs:pr-[10px] pr-[0px] hover:opacity-70" target="_blank" rel="noreferrer" href="https://github.com/sadovsd/transcriptomics_aging_clock_CORN/blob/main/rotation1_presentation_davyd.pdf">
