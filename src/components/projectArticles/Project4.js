...
const Project4 = () => {
    ...
    const projectWithId = PROJECTS.find((project) => project.id === 4);
    ...
    return (
        <div className="container w-[70rem] mt-20 text-left">
            ...
            <h3 className="text-neutral-500 text-[1.9rem] font-normal mt-8 leading-relaxed">
                How I used Semantic Scholar API to Retrieve Raw Data about Large Langauge Model Publications, BERTopic to Cluster Papers, and an RShiny Dashboard to Interactively Visualize Aspects of the Research Landscape
            </h3>
            <hr className="w-[65rem] mt-8"></hr>
            <div className="w-[65rem] flex items-start justify-between">
                <IconsWithText
                    leftText={date}
                    className="mt-4 "
                />
                <div className="mt-2 flex flex-wrap">
                    <a className="pr-[30px]" target="_blank" rel="noreferrer" href="https://medium.com/@sadovsd/visualizing-the-sea-of-llm-research-published-in-2023-af40298adf4e">
                        <MdOutlineArticle className="inline mr-2 text-3xl"/>
                        <span className="ml-1 leading-none whitespace-nowrap font-medium">
                            Read Article
                        </span>
                    </a>
                    <a className="pr-[30px]" target="_blank" rel="noreferrer" href="https://github.com/sadovsd/semantic-scholar-visualizer">
                        <FaCode className="inline mr-2 text-3xl"/>
                        <span className="ml-1 leading-none whitespace-nowrap font-medium">
                            View Code
                        </span>
                    </a>
                    <a className="pr-[0px]" target="_blank" rel="noreferrer" href="https://davydsadovskyy.shinyapps.io/llm-papers-2023-dashboard/">
